...
def plot_bar_chart(sample_data_df, summary_stats, fig_title, x_label, y_label, custom_colors, custom_names, fig_width, fig_height, show_grid):
    ...
    sample_means.plot(kind='bar', yerr=sample_errors, ax=ax, capsize=5, color=[custom_colors[sample] for sample in sample_means.index], edgecolor='black', alpha=0.75)
        ...
        if p_values_str != 'n.s.' and p_values_str != 'n.a.':
            ...
            for comp in comparisons:
                ...
                if p_value < 0.05:
                    ...
                    h = 0.05 * max(sample_means + sample_errors)
...
def main():
    ...
    with st.sidebar:
        ...
        - Significance <0.05 is automatically indicated. Further signficance levels (WIP)
